...
<html>
<head>
    <title>Report Incident - Crime Management</title>
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <p>Please provide accurate details to assist the investigation.</p>
        </div>
        
        <form action="../api/report_crime.php" method="POST" enctype="multipart/form-data">
            
            <label>Incident Title</label>
            <input type="text" name="title" required placeholder="e.g. Theft at Main Street Market">
            ...
            <textarea name="description" required placeholder="Describe what happened, when, and who was involved..."></textarea>
            ...
            <div class="file-upload-box">
                ...
                <p style="margin: 10px 0 0; color: #64748b; font-size: 0.9rem;">Click to upload files (Images & Videos supported)</p>
            </div>
